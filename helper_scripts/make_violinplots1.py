...
def calculateTauSimulation(transmissionFile: str, contactNetFile: str, experiment: str, intStr: str, algm: str) -> float:
	...
	for i in range(len(efficacy)):
		if len(efficacy[i]) != 2:
			raise ValueError("Input must be efficacy file as generated by ./SEPIA.py (TSV with 2 columns: PERSON<TAB>EFFICACY.", efficacy[i], inputFile, transmissionFile, efficacy)
			return
